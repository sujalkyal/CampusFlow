...
const EditStudentPopup = ({ isOpen, onClose, student }) => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 bg-[#010101]/80 backdrop-blur-sm" onClick={onClose}></div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex justify-end space-x-3 mt-6">
                                <motion.button 
                                    type="button" 
                                    onClick={onClose} 
                                    className="px-5 py-2.5 bg-[#010101]/80 border border-[#3a3153]/50 text-[#b1aebb] rounded-lg"
                                ...
                                <motion.button 
                                    type="submit" 
                                    className="px-5 py-2.5 bg-[#5f43b2] text-[#fefdfd] rounded-lg relative overflow-hidden group"
