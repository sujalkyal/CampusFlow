...
export default function AssignmentPage() {
  return (
    <div className="min-h-screen bg-[#010101] text-[#fefdfd]">
      <Head>
      ...
      <main className="container mx-auto py-10 px-6">
        ...
        >
          <GlassCard><AssignmentDetails /></GlassCard>
          <GlassCard><FilesSection /></GlassCard>
        </motion.div>
        ...
        >
          <GlassCard><SubmissionStatus /></GlassCard>
          <GlassCard><StudentSubmissions /></GlassCard>
        </motion.div>
      </main>
    </div>
  );
...
const GlassCard = ({ children }) => (
  <motion.div 
    className="bg-[#3a3153]/40 backdrop-blur-xl border border-[#b1aebb]/30 rounded-xl shadow-lg p-6 transition duration-300 hover:scale-[1.02]"
